...
fun test() {
    ...
    fooByte(1 - 1)
    <!INAPPLICABLE_CANDIDATE!>fooByte<!>(1 - 1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
    ...
    fooLong(1 - 1)
    <!INAPPLICABLE_CANDIDATE!>fooLong<!>(1 - 1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
    <!INAPPLICABLE_CANDIDATE!>fooLong<!>(1 - 1.toByte())
    fooLong(1 - 1.toLong())
    <!INAPPLICABLE_CANDIDATE!>fooLong<!>(1 - 1.toShort())

    fooShort(1 - 1)
    <!INAPPLICABLE_CANDIDATE!>fooShort<!>(1 - 1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
