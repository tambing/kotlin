...
fun test() {
    ...
    <!INAPPLICABLE_CANDIDATE!>fooByte<!>(-1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
    ...
    <!INAPPLICABLE_CANDIDATE!>fooLong<!>(-1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
    ...
    <!INAPPLICABLE_CANDIDATE!>fooShort<!>(-1.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!>)
