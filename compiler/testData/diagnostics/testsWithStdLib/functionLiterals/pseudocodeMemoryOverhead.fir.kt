...
private val unaryOperations: HashMap<UnaryOperationKey<*>, Pair<Function1<Any?, Any>, Function1<Long, Long>>>
        ...
        unaryOperation(BYTE, "toByte", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toByte()<!> }, emptyUnaryFun),
        unaryOperation(CHAR, "toInt", { a -> a.toInt() }, emptyUnaryFun),
        unaryOperation(CHAR, "toChar", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toChar()<!> }, emptyUnaryFun),
        ...
        unaryOperation(DOUBLE, "toDouble", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toDouble()<!> }, emptyUnaryFun),
        ...
        unaryOperation(FLOAT, "toFloat", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toFloat()<!> }, emptyUnaryFun),
        ...
        unaryOperation(INT, "toInt", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toInt()<!> }, emptyUnaryFun),
        ...
        unaryOperation(LONG, "toLong", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toLong()<!> }, emptyUnaryFun),
        ...
        unaryOperation(SHORT, "toShort", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toShort()<!> }, emptyUnaryFun),
        unaryOperation(SHORT, "toByte", { a -> a.toByte() }, emptyUnaryFun),
        unaryOperation(STRING, "toString", { a -> a.<!REDUNDANT_CALL_OF_CONVERSION_METHOD!>toString()<!> }, emptyUnaryFun)
)
